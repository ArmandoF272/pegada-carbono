...
ActiveRecord::Schema[8.1].define(version: 2026_05_12_000454) do
  ...
  create_table "activities", force: :cascade do |t|
    ...
    t.index ["calculation_id"], name: "index_activities_on_calculation_id"
  end
  ...
  add_foreign_key "activities", "calculations"
